            ...
            <View style={styles.modalContainer}>
             <ScrollView style={{width:"100%"}}>
              <KeyboardAvoidingView style={styles.KeyboardAvoidingView}>
                  ...
                  <TextInput style={styles.formTextInput} placeholder="First Name"  onChangeText={(text)=>{this.setState({firstName:text})}} maxLength={8}>
               
               </TextInput>
               <TextInput style={styles.formTextInput} placeholder="Last Name"  onChangeText={(text)=>{this.setState({lastName:text})}} maxLength={8}>
               
               </TextInput>
               <TextInput keyboardType={"numeric"} style={styles.formTextInput} placeholder="Contact Number"  onChangeText={(text)=>{this.setState({contact:text})}} maxLength={10}>
               
               </TextInput>
               <TextInput style={styles.formTextInput} placeholder="Address"  onChangeText={(text)=>{this.setState({address:text})}} multiline={true}>
               ...
               <TextInput style={styles.formTextInput} placeholder="Rewrite Password"  onChangeText={(text)=>{this.setState({confirmPassword:text})}} secureTextEntry={true}>
    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <TextInput style={styles.loginBox} placeholder="abc@example.com" keyboardType="email-address" onChangeText={(text)=>{this.setState({emailId:text})}} placeholderTextColor="white">
               
               </TextInput>
               <TextInput style={styles.loginBox} placeholder=" Enter Password" secureTextEntry={true} onChangeText={(text)=>{this.setState({password:text})}} placeholderTextColor="white" >
